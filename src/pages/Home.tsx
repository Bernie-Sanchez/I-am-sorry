            ...
            <div className="container mt-4">
                {blogs.map(blog => (
                    <div className="row">
                        ...
                        <div className="col-lg-6 col-md-8 col-sm-12" key={blog.id}>
                ...
                <div className="d-flex justify-content-center align-items-center mt-5 mb-5 gap-3">
                    <button className="btn btn-sm page-button" disabled={page === 1} onClick={() => setPage(page - 1)}><b>Previous</b></button>
                    <span className="text-color-1">Page {page} of {Math.ceil(total / PAGE_SIZE)}</span>
                    <button className="btn btn-sm page-button" disabled={page >= Math.ceil(total / PAGE_SIZE)} onClick={() => setPage(page + 1)}><b>Next</b></button>
                </div>
            </div>
        </div>
    );
